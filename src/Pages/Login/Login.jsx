    ...
    return (
        <div className="form-container mx-auto my-14">
            ...
            <div className="social-buttons">
                ...
                <button className="social-button bg-blue-500 hover:bg-blue-600">
            ...
            <Link className="forgot-password-link link" href="#">Forgot Password</Link>
            ...
            <p className="signup-link">
                ...
                <Link to="/registration" className="signup-link link" href="#"> Register now</Link>
            </p>
        </div>
    );
};
